...
class MedicalRecordController extends Controller
{
     ...
     *             @OA\Property(property="infections_previas", type="boolean", example=false, description="Previous infections"),
     ...
     *             @OA\Property(property="fontanelas", type="string", example="Closed", description="Fontanelles"),
