...
class KidController extends Controller
{
     ...
     *            @OA\Property(property="pediatrician", type="string", format="string", example="Manuel Acosta"),
     *            @OA\Property(property="pediatrician_phone", type="string", format="string", example="8095583443"),
     *         ),
     *      ),
     *     @OA\Response(
